...
<body>
    <div class="container">
        ...
        if (empty($image) || $image["error"] == UPLOAD_ERR_NO_FILE) {
            ...
            if ( !in_array($imageExtension, $validImageExtension) ){
              ...
              $query = "INSERT INTO users (image) VALUES ('$newImageName')";
  ...
  if (isset($newImageName)) {
    echo "<div class='alert alert-success'>You are registered successfully. Your image: <img src='img/$newImageName' alt='Uploaded Image'></div>";
  }
